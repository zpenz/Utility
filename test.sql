...
CREATE TABLE xk_shows (
  ...
  show_title varchar(50) NOT NULL COMMENT '标题',
  ...
  show_position varchar(200) COMMENT '位置',
...
CREATE TABLE xk_applicants(
  user_id int(100) unsigned NOT NULL AUTO_INCREMENT, 
  applicant_name varchar(100) NOT NULL COMMENT '姓名',
  applicant_sex varchar(10) NOT NULL COMMENT '性别',
  applicant_birth varchar(20) NOT NULL COMMENT '生日',
  applicant_id varchar(20) NOT NULL COMMENT '学号',
  applicant_major varchar(50) NOT NULL COMMENT '专业',
  applicant_academy varchar(50) NOT NULL COMMENT '学院',
  applicant_grade varchar(50) NOT NULL COMMENT '年级',
  applicant_class varchar(50) NOT NULL COMMENT '班级',
  applicant_address varchar(200) NOT NULL COMMENT '家庭住址',
  applicant_phone_number varchar(12) NOT NULL COMMENT '电话',
  applicant_open_id varchar(64) NOT NULL COMMENT 'openid',
  applicant_nick_name varchar(50) NOT NULL COMMENT '昵称',
  applicant_time    varchar(200) NOT NULL COMMENT '报名时间',
  PRIMARY KEY(user_id)
)ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

CREATE TABLE xk_agent(
  agent_id int(100) unsigned NOT NULL AUTO_INCREMENT,
  agent_info varchar(2048) NOT NULL COMMENT 'agent信息',
  agent_time varchar(200)  NOT NULL COMMENT 'agent时间',
  agent_ip   varchar(50)   NOT NULl COMMENT 'ip',
